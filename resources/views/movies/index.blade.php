                ...
                @forelse($movies as $movie)
                    ...
                    <div class="bg-gray-900 rounded-2xl shadow-xl border border-gray-800 overflow-hidden hover:shadow-2xl hover:border-indigo-500 transition-all duration-300 transform hover:-translate-y-2 group flex flex-col h-full relative">
                        ...
                        <div class="relative h-[360px] sm:h-[400px] overflow-hidden bg-gray-800">
                            ...
                            <div class="absolute top-3 right-3 bg-gray-950/80 text-yellow-400 font-bold px-2 py-1 rounded-lg flex items-center text-xs md:text-sm backdrop-blur-md shadow-sm z-10 border border-gray-700/50">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-gray-950/90 via-gray-950/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-3">
                                ...
                                <form action="{{ route('watchlists.store') }}" method="POST" class="transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-75">
                                    ...
                                    <button type="submit" class="text-white bg-gray-800 border border-gray-700 hover:bg-gray-700 font-bold px-6 py-2.5 rounded-full shadow-lg flex items-center w-40 justify-center">
                        ...
                        <div class="p-4 flex flex-col flex-grow bg-gray-900 relative z-10">
                            <a href="{{ route('movies.show', ['id' => $movie['id'], 'type' => $type]) }}" class="hover:text-indigo-400 transition">
                                <h3 class="font-bold text-white text-lg line-clamp-1 mb-2" title="{{ $title }}">
                                    {{ $title }}
                                </h3>
                            </a>
