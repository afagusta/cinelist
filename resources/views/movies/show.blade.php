<x-app-layout>
    <div class="relative w-full bg-gray-950 min-h-[50vh] md:min-h-[70vh] flex items-center pb-12 pt-8 md:pt-16">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            ...
            <a href="{{ route('movies.index') }}" class="inline-flex items-center text-gray-300 hover:text-white mb-6 md:mb-10 transition duration-300 group bg-gray-800/50 hover:bg-gray-700/50 px-4 py-2 rounded-full backdrop-blur-sm w-fit border border-gray-700/50">
            ...
            <div class="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
                ...
                <div class="w-40 sm:w-48 md:w-1/3 lg:w-1/4 flex-shrink-0 mx-auto md:mx-0 relative group">
                    ...
                    @else
                        <div class="w-full aspect-[2/3] bg-gray-900 rounded-2xl flex flex-col items-center justify-center text-gray-500 border border-gray-800 shadow-2xl">
                ...
                <div class="w-full md:w-2/3 lg:w-3/4 flex flex-col justify-center text-white">
                    ...
                    <div class="flex flex-wrap items-center gap-4 text-sm sm:text-base text-gray-300 mb-6 font-medium">
                        ...
                        @php
                            ...
                            if (!$runtime && isset($movie['episode_run_time']) && is_array($movie['episode_run_time']) && count($movie['episode_run_time']) > 0) {
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-1/3">
                    <div class="bg-gray-900 rounded-2xl shadow-xl border border-gray-800 p-6 sticky top-24">
                        <h3 class="text-xl font-extrabold text-white mb-6 flex items-center">
                            <svg class="w-6 h-6 mr-2 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                            Tulis Ulasan
                        </h3>
                        ...
                        <form action="{{ route('reviews.store') }}" method="POST">
                            ...
                            <div class="mb-5">
                                <label for="rating" class="block text-sm font-bold text-gray-300 mb-2">Rating Bintang</label>
                                <select name="rating" id="rating" class="w-full bg-gray-950 border border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm text-gray-300 py-3 appearance-none cursor-pointer" required>
                            ...
                            <div class="mb-6">
                                <label for="comment" class="block text-sm font-bold text-gray-300 mb-2">Komentar / Ulasan Anda</label>
                                <textarea name="comment" id="comment" rows="5" placeholder="Bagaimana pendapatmu tentang film ini?" class="w-full bg-gray-950 border border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm text-white placeholder-gray-500 resize-none py-3" required></textarea>
                            </div>

                            <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-6 py-3.5 rounded-xl transition shadow-lg flex items-center justify-center">
                                Kirim Ulasan
                            </button>
                        </form>
                    </div>
                ...
                <div class="w-full lg:w-2/3">
                    <div class="bg-gray-900 rounded-2xl shadow-xl border border-gray-800 p-6 md:p-8">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-8 pb-4 border-b border-gray-800">
                            <h3 class="text-xl font-extrabold text-white mb-3 sm:mb-0">
                                Ulasan Pengguna CineList ({{ $reviews->count() ?? 0 }})
                            </h3>
                            
                            @if($reviews->count() > 0)
                                <div class="flex items-center text-sm font-bold text-indigo-300 bg-indigo-900/30 px-4 py-2 rounded-xl border border-indigo-800/50 w-fit">
                        ...
                        <div class="space-y-6">
                            ...
                            @empty
                                <div class="text-center py-12 px-4">
                                    ...
                                    <h4 class="text-lg font-bold text-white mb-2">Belum Ada Ulasan</h4>
